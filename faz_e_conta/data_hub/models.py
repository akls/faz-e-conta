...
class Aluno(models.Model):
    ...
    data_ultima_renovacao = models.DateField(default=datetime.date.today, null=True, blank=True)
...
class Vacinacao(models.Model):
    ...
    data_vacina = models.DateField(default=datetime.date.today, null=True, blank=True)
...
class Salario(models.Model):
    ...
    data_pagamento = models.DateField(default=datetime.date.today, null=True, blank=True)
