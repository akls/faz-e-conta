"""
Django settings for faz_e_conta project.
...
SECRET_KEY = 'django-insecure-9^nc5!64_^88c!f!+&+gvt-!tg+r9&+q&2l^cyy-!d1e9k*c=%'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR.parent / 'data' / 'fazeconta.sqlite3',
    }
}
